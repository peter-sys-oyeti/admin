...
function createPanelIfMobxLoaded() {
  ...
  chrome.devtools.inspectedWindow.eval('!!(Object.keys(window.__MOBX_DEVTOOLS_GLOBAL_HOOK__.collections).length)', function (pageHasMobx) {
    ...
    panelCreated = true;
    chrome.devtools.panels.create('MobX', '', 'panel.html', function () {});
  });
}
